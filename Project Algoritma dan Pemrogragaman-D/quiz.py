...
pilihan = (("A. Bali", "B. NTT", "C. NTB", "D. Jawa Timur"),
           ("A. B.J Habibie ", "B. Jokowi", "C. Soekarno", "D. Abdurahman Wahid"),
           ("A. Majelis Perwakilan Rakyat", "B. Majelis Permusyawaratan Rakyat", "C. Majelis Perhimpunan Rakyat", "D. Majelis Perserikatan Rakyat"),
           ("A. 17 Agustus", "B. 1 Maret", "C. 1 Juni ", "D. 1 Desember"),
           ("A. Negeri Tirai Bambu", "B. Negeri Gingseng", "C. Zamrud Khatulistiwa", "D. Negeri Kincir Angin"))
...
for i in bank_soal:
    ...
    jawab = input("Masukkan (A, B, C, D): ").upper()
